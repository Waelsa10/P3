...
function ChatPage() {
    ...
    // ✅ NEW: Mark all received "sent" messages as "delivered" when chat loads
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        const markMessagesAsDelivered = async ()=>{
            try {
                ...
                // Find all messages that are "sent" and NOT from current user
                const sentMessagesQuery = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["query"])(messagesRef, (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["where"])("status", "==", __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$constants$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["MESSAGE_STATUS"].SENT), (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["where"])("user", "!=", user.email));
                const snapshot = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["getDocs"])(sentMessagesQuery);
                if (snapshot.empty) {
                    console.log(`✅ [Chat ${chatId}] No messages to mark as delivered`);
                    return;
                }
                ...
                await batch.commit();
                console.log(`✅ [Chat ${chatId}] Marked ${snapshot.docs.length} messages as delivered`);
            } catch (error) {
                console.error(`❌ [Chat ${chatId}] Error marking messages as delivered:`, error);
            }
        };
        // Mark messages as delivered when chat loads
        markMessagesAsDelivered();
        // Also mark on window focus (when user returns to tab)
        const handleFocus = ()=>{
            if (isOnline) {
                markMessagesAsDelivered();
            }
    ...
    // ✅ NEW: Mark all received messages as "read" when viewing this chat
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (!chatId || !user?.email || !isOnline) return;
        const markMessagesAsRead = async ()=>{
            try {
                const messagesRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$firebase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], "chats", chatId, "messages");
                // Find all messages that are "sent" or "delivered" and NOT from current user
                const unreadMessagesQuery = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["query"])(messagesRef, (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["where"])("user", "!=", user.email), (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["where"])("status", "in", [
                ...
                const snapshot = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["getDocs"])(unreadMessagesQuery);
                if (snapshot.empty) {
                    console.log(`✅ [Chat ${chatId}] No messages to mark as read`);
                    return;
                }
                const batch = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2f$firestore__$5b$external$5d$__$28$firebase$2f$firestore$2c$__esm_import$29$__["writeBatch"])(__TURBOPACK__imported__module__$5b$project$5d2f$firebase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"]);
                snapshot.docs.forEach((doc)=>{
                ...
                await batch.commit();
                console.log(`✅ [Chat ${chatId}] Marked ${snapshot.docs.length} messages as read`);
            } catch (error) {
                console.error(`❌ [Chat ${chatId}] Error marking messages as read:`, error);
            }
        };
        ...
        window.addEventListener('focus', handleFocus);
        // Mark as read periodically while viewing (every 5 seconds)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d4dea285._.js.map