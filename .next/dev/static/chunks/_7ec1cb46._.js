...
const MESSAGE_STATUS = {
    ...
    DELIVERED: 'delivered',
    READ: 'read',
    FAILED: 'failed' // Message failed to send (for error handling)
};
...
function MessageStatus({ status, darkMode }) {
    // Handle pending/sending state
    if (!status || status === __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$constants$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MESSAGE_STATUS"].PENDING || status === __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$constants$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MESSAGE_STATUS"].SENDING) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatusContainer, {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PendingIcon, {
                darkMode: darkMode
            }, void 0, false, {
                fileName: "[project]/components/ChatScreen/utils/messageStatus.js",
                lineNumber: 15,
                columnNumber: 9
            }, this)
        }, void 0, false, {
    ...
    if (status === __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$constants$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MESSAGE_STATUS"].SENT) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatusContainer, {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SingleCheck, {
                darkMode: darkMode
            }, void 0, false, {
                fileName: "[project]/components/ChatScreen/utils/messageStatus.js",
                lineNumber: 24,
    ...
    if (status === __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$constants$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MESSAGE_STATUS"].DELIVERED) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatusContainer, {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DoubleCheckGray, {
                darkMode: darkMode
            }, void 0, false, {
                fileName: "[project]/components/ChatScreen/utils/messageStatus.js",
                lineNumber: 33,
    ...
    if (status === __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$constants$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MESSAGE_STATUS"].READ) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatusContainer, {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DoubleCheckBlue, {}, void 0, false, {
                fileName: "[project]/components/ChatScreen/utils/messageStatus.js",
                lineNumber: 42,
                columnNumber: 9
            }, this)
...
;
;
const useMessageStatus = (chatId, recipientEmail, isSelfChat = false)=>{
    _s();
    ...
    const recipientListenerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // ✅ Mark recipient messages as read (messages TO you)
    const markMessagesAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMessageStatus.useCallback[markMessagesAsRead]": async ()=>{
            ...
            console.log(`📖 Marking messages as read - isSelfChat: ${isSelfChat}`);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$utils$2f$messageStatus$2e$js__$5b$client$5d$__$28$ecmascript$29$__["markRecipientMessagesAsRead"])(chatId, user.email, recipientEmail, isSelfChat);
        }
    ...
    // ✅ Mark YOUR messages as delivered
    const markYourMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMessageStatus.useCallback[markYourMessages]": async ()=>{
            if (!chatId || !recipientEmail || !user) return;
            console.log(`📤 Marking YOUR messages as delivered - isSelfChat: ${isSelfChat}`);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$utils$2f$messageStatus$2e$js__$5b$client$5d$__$28$ecmascript$29$__["markYourMessagesAsDelivered"])(chatId, user.email, recipientEmail, isSelfChat);
        }
    }["useMessageStatus.useCallback[markYourMessages]"], [
        chatId,
        recipientEmail,
        user,
        isSelfChat
    ...
    // ✅ Mark YOUR messages as delivered (only for self-chat or when recipient comes online)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMessageStatus.useEffect": ()=>{
            if (!chatId || !recipientEmail || !user) return;
            if (isSelfChat) {
                // For self-chat, mark as delivered after a short delay
                const timer = setTimeout(markYourMessages, 500);
                return ({
                    "useMessageStatus.useEffect": ()=>clearTimeout(timer)
                })["useMessageStatus.useEffect"];
            }
        // For regular chat, this will be handled by the recipient status listener
        }
    }["useMessageStatus.useEffect"], [
        chatId,
        recipientEmail,
    ...
    // ✅ Listen to recipient status ONLY for regular chats (not self-chat)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMessageStatus.useEffect": ()=>{
            if (isSelfChat || !recipientEmail || !user) return;
            console.log(`📡 Setting up recipient status listener for ${recipientEmail}`);
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$utils$2f$messageStatus$2e$js__$5b$client$5d$__$28$ecmascript$29$__["subscribeToRecipientStatus"])(recipientEmail, {
                "useMessageStatus.useEffect.unsubscribe": (recipientData)=>{
                    console.log(`📡 Recipient ${recipientEmail} status: ${recipientData.isOnline ? '🟢 ONLINE' : '🔴 OFFLINE'}`);
                    if (recipientData.isOnline) {
                        console.log(`🟢 ${recipientEmail} came online - marking YOUR messages as delivered`);
                        markYourMessages();
                    }
                }
            }["useMessageStatus.useEffect.unsubscribe"]);
            recipientListenerRef.current = unsubscribe;
            return ({
                "useMessageStatus.useEffect": ()=>{
                    if (recipientListenerRef.current) {
                        console.log(`🔌 Cleaning up recipient status listener for ${recipientEmail}`);
                        recipientListenerRef.current();
                        recipientListenerRef.current = null;
                    }
                }
            })["useMessageStatus.useEffect"];
        }
    ...
    // ✅ Mark as read on user interactions
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMessageStatus.useEffect": ()=>{
            if (!chatId || !recipientEmail || !user) return;
            const handleFocus = {
            ...
            const handleScroll = {
                "useMessageStatus.useEffect.handleScroll": ()=>{
                    ...
                    scrollTimeout = setTimeout(markMessagesAsRead, 500);
                }
            }["useMessageStatus.useEffect.handleScroll"];
...
_s(useMessageStatus, "s0eCHnIFDPgOqGDXgYHhKfCuoM4=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$hooks$2f$useMessageStatus$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ChatScreen/hooks/useMessageStatus.js [client] (ecmascript)"); // ✅ NEW
// Components
...
function ChatScreen({ chat, messages, isMobile = false, onToggleSidebar = ()=>{} }) {
    ...
    // ✅ REPLACE all message status useEffects with just this hook
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatScreen$2f$hooks$2f$useMessageStatus$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMessageStatus"])(chatId, recipientEmail, isSelfChat);
...
_s(ChatScreen, "JG8W7LhW1KXEgSiNdqnpkle2R/g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$firebase$2d$hooks$2f$auth$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuthState"],
...
//# sourceMappingURL=_7ec1cb46._.js.map