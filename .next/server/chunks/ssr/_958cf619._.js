...
`,r=h.default.p`
  ...
  margin-top: 10px;
  font-size: 14px;
`;a.s(["default",0,function(){let a=(0,k.useRouter)(),[b,c]=(0,e.useState)(!1),[h,i]=(0,e.useState)(""),{darkMode:m}=(0,e.useContext)(l.DarkModeContext)||{darkMode:!1},s=async()=>{try{c(!0),i("");let b=await (0,g.signInWithPopup)(f.auth,f.provider);console.log("Sign in successful:",b.user),a.push("/")}catch(a){console.error("Sign in error:",a),"auth/popup-blocked"===a.code?i("Popup was blocked. Please allow popups for this site."):"auth/popup-closed-by-user"===a.code?i("Sign in was cancelled."):i(a.message)}finally{c(!1)}};return(0,d.jsxs)(n,{darkMode:m,children:[(0,d.jsx)(j.default,{children:(0,d.jsx)("title",{children:"Login"})}),(0,d.jsxs)(o,{darkMode:m,children:[(0,d.jsx)(p,{src:"https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg",alt:"WhatsApp Logo"}),(0,d.jsx)(q,{variant:"outlined",onClick:s,disabled:b,darkMode:m,children:b?"Signing in...":"Sign in with Google"}),h&&(0,d.jsx)(r,{darkMode:m,children:h})]})]})}]),c()}catch(a){c(a)}},!1),56354,a=>a.a(async(b,c)=>{try{var d=a.i(27669),e=a.i(39196),f=a.i(45542),g=a.i(27390),h=b([e,g]);[e,g]=h.then?(await h)():h,a.s(["useOnlineStatus",0,()=>{let[a]=(0,f.useAuthState)(g.auth),b=(0,d.useRef)(!1);(0,d.useEffect)(()=>{if(!a)return;let c=(0,e.doc)(g.db,"users",a.uid),d=async a=>{if(!b.current){b.current=!0;try{await (0,e.setDoc)(c,{isOnline:a,lastSeen:(0,e.serverTimestamp)()},{merge:!0})}catch(a){console.error("❌ Error updating online status:",a)}finally{setTimeout(()=>{b.current=!1},1e3)}}};d(!0);let f=()=>{document.hidden?d(!1):d(!0)},h=()=>d(!0),i=()=>d(!1),j=()=>{navigator.sendBeacon(`/api/setOffline?uid=${a.uid}`,JSON.stringify({uid:a.uid})),d(!1)};document.addEventListener("visibilitychange",f),window.addEventListener("online",h),window.addEventListener("offline",i),window.addEventListener("beforeunload",j);let k=setInterval(()=>{!document.hidden&&navigator.onLine&&d(!0)},25e3);return()=>{clearInterval(k),document.removeEventListener("visibilitychange",f),window.removeEventListener("online",h),window.removeEventListener("offline",i),window.removeEventListener("beforeunload",j),d(!1)}},[a])}]),c()}catch(a){c(a)}},!1),27342,a=>a.a(async(b,c)=>{try{var d=a.i(8171),e=a.i(27669),f=a.i(45542),g=a.i(27390),h=a.i(39196),i=a.i(3086),j=a.i(67696),k=a.i(71197),l=a.i(56354),m=b([g,h,j,l]);[g,h,j,l]=m.then?(await m)():m,a.s(["default",0,function({Component:a,pageProps:b}){let[c,m]=(0,f.useAuthState)(g.auth);return((0,l.useOnlineStatus)(),(0,e.useEffect)(()=>{if(!c)return;let a=(0,h.doc)(g.db,"users",c.uid),b=async()=>{try{await (0,h.setDoc)(a,{email:c.email,lastSeen:(0,h.serverTimestamp)(),photoURL:c.photoURL||null},{merge:!0})}catch(a){console.error("❌ Error updating lastSeen:",a)}};b();let d=setInterval(b,2e4);return window.addEventListener("focus",b),()=>{clearInterval(d),window.removeEventListener("focus",b)}},[c]),m)?(0,d.jsx)(i.default,{}):c?(0,d.jsx)(k.DarkModeProvider,{children:(0,d.jsx)(a,{...b})}):(0,d.jsx)(j.default,{})}]),c()}catch(a){c(a)}},!1)];
