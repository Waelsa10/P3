...
`,tt=o.default.div`
  ...
  @media (max-width: 1024px) {
    ...
    max-width: 85%;
    width: 85%;
    transform: ${e=>e.sidebarOpen?"translateX(0)":"translateX(-100%)"};
